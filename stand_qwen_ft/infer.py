...
def main():
    #change this
    model_path = Path("/Users/xiaobu/Desktop/repos/xxq/qwen2.5-0.5b-ft-merged")
    input_file = Path("/Users/xiaobu/Desktop/repos/xxq/train/stance_split_meta/test_infer.jsonl")
    output_file = Path("/Users/xiaobu/Desktop/repos/xxq/train/stance_split_meta/test_pred.jsonl")
    #change end
